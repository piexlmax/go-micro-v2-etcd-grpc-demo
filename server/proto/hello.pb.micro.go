...
type SayService interface {
	Hello(ctx context.Context, in *Req, opts ...client.CallOption) (*Res, error)
}
...
func (c *sayService) Hello(ctx context.Context, in *Req, opts ...client.CallOption) (*Res, error) {
...
func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		Hello(ctx context.Context, in *Req, out *Res) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) Hello(ctx context.Context, in *Req, out *Res) error {
